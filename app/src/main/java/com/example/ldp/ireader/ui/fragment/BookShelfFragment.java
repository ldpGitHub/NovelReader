...
import com.example.ldp.ireader.event.DeleteResponseEvent;
import com.example.ldp.ireader.event.DeleteTaskEvent;
import com.example.ldp.ireader.event.DownloadMessage;
import com.example.ldp.ireader.event.RecommendBookEvent;
import com.example.ldp.ireader.model.bean.CollBookBean;
import com.example.ldp.ireader.model.local.BookRepository;
import com.example.ldp.ireader.presenter.BookShelfPresenter;
...
import com.example.ldp.ireader.ui.activity.SearchActivity;
import com.example.ldp.ireader.ui.adapter.CollBookAdapter;
...
import com.example.ldp.ireader.widget.refresh.ScrollRefreshRecyclerView;
