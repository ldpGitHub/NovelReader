...
import com.example.ldp.ireader.model.bean.packages.BillBookPackage;
...
import com.example.ldp.ireader.model.bean.packages.BookHelpsPackage;
import com.example.ldp.ireader.model.bean.packages.BookListDetailPackage;
import com.example.ldp.ireader.model.bean.packages.BookListPackage;
import com.example.ldp.ireader.model.bean.packages.BookReviewPackage;
...
import com.example.ldp.ireader.model.bean.packages.BookTagPackage;
import com.example.ldp.ireader.model.bean.packages.ChapterInfoPackage;
import com.example.ldp.ireader.model.bean.packages.CommentDetailPackage;
import com.example.ldp.ireader.model.bean.packages.CommentsPackage;
import com.example.ldp.ireader.model.bean.packages.HelpsDetailPackage;
import com.example.ldp.ireader.model.bean.packages.HotCommentPackage;
import com.example.ldp.ireader.model.bean.packages.HotWordPackage;
import com.example.ldp.ireader.model.bean.packages.KeyWordPackage;
import com.example.ldp.ireader.model.bean.packages.RecommendBookListPackage;
import com.example.ldp.ireader.model.bean.packages.RecommendBookPackage;
import com.example.ldp.ireader.model.bean.packages.ReviewDetailPackage;
import com.example.ldp.ireader.model.bean.packages.SearchBookPackage;
import com.example.ldp.ireader.model.bean.packages.SortBookPackage;
import com.example.ldp.ireader.model.bean.packages.TagSearchPackage;
